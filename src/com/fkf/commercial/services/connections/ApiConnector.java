...
public class ApiConnector {
    ...
    public boolean addToMyFavorite(String recipeId, Activity activity) {
        ...
        try {
            ...
            Log.d("Logged User name : ", loggedUserDetails.get("username"));
            Log.d("Logged User password : ", loggedUserDetails.get("username"));

            reqParams.put("username", loggedUserDetails.get("username"));
            reqParams.put("password", loggedUserDetails.get("password"));
